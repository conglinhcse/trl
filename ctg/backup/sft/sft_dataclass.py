...
class ROCDataset(Dataset):
    ...
    def __getitem__(self, i):
        ...
        if self.generate_mode:
            ...
            prompt =  "TASK: Write the next sentence of the story containing the following keywords: " + ", ".join(selected_keywords) + "." + \
                    "\nSTORY: " + self.ls_leading_contexts[i] + \
                    "\nSENTENCE: "
            ...
            prompt =  "TASK: Write the next sentence of the story containing the following keywords: " + ", ".join(selected_keywords) + "." + \
                    "\nSTORY: " + self.ls_leading_contexts[i] + \
                    "\nSENTENCE: " + self.ls_expected_sentences[i] + \
